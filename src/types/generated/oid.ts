...
export class Oid<in out N extends number> extends Anynonarray<N> {
  ...
  pgIndexamProgressPhasename<M0 extends types.Int8<any> | bigint>(arg0: M0): types.Text<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Int8, allowPrimitive: true }], types.Text]]); return runtime.PgFunc("pg_indexam_progress_phasename", [this, ...__rest], __rt) as any; }
