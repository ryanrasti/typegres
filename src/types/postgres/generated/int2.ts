...
export class Int2<in out N extends number> extends Anynonarray<N> {
  declare [meta]: {
    __class: typeof types.Int2;
    __raw: runtime.Sql;
    __nullability: N;
    __nullable: types.Int2<0 | 1>;
    __nonNullable: types.Int2<1>;
    __aggregate: types.Int2<number>;
    __any: types.Int2<any>;
  };
  static __typname = runtime.sql`int2`;
  static __typnameText = "int2";
  @expose.unchecked()
  abs(): types.Int2<N> { const [__rt, ...__rest] = runtime.match([], [[[], types.Int2]]); return runtime.funcCall("abs", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  ...
  @expose.unchecked()
  int2Abs(): types.Int2<N> { const [__rt, ...__rest] = runtime.match([], [[[], types.Int2]]); return runtime.funcCall("int2abs", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  int2And<M0 extends types.Int2<any> | number>(arg0: M0): types.Int2<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Int2, allowPrimitive: true }], types.Int2]]); return runtime.funcCall("int2and", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  int2Larger<M0 extends types.Int2<any> | number>(arg0: M0): types.Int2<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Int2, allowPrimitive: true }], types.Int2]]); return runtime.funcCall("int2larger", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  int2Not(): types.Int2<N> { const [__rt, ...__rest] = runtime.match([], [[[], types.Int2]]); return runtime.funcCall("int2not", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  int2Or<M0 extends types.Int2<any> | number>(arg0: M0): types.Int2<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Int2, allowPrimitive: true }], types.Int2]]); return runtime.funcCall("int2or", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  int2Send(): types.Bytea<N> { const [__rt, ...__rest] = runtime.match([], [[[], types.Bytea]]); return runtime.funcCall("int2send", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  int2Shl<M0 extends types.Int4<any> | number>(arg0: M0): types.Int2<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Int4, allowPrimitive: true }], types.Int2]]); return runtime.funcCall("int2shl", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  int2Shr<M0 extends types.Int4<any> | number>(arg0: M0): types.Int2<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Int4, allowPrimitive: true }], types.Int2]]); return runtime.funcCall("int2shr", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  int2Smaller<M0 extends types.Int2<any> | number>(arg0: M0): types.Int2<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Int2, allowPrimitive: true }], types.Int2]]); return runtime.funcCall("int2smaller", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  int2Xor<M0 extends types.Int2<any> | number>(arg0: M0): types.Int2<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Int2, allowPrimitive: true }], types.Int2]]); return runtime.funcCall("int2xor", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  ...
  @expose.unchecked()
  mod<M0 extends types.Int2<any> | number>(arg0: M0): types.Int2<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Int2, allowPrimitive: true }], types.Int2]]); return runtime.funcCall("mod", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  ...
  @expose.unchecked()
  bitAnd(): types.Int2<0 | 1> { const [__rt, ...__rest] = runtime.match([], [[[], types.Int2]]); return runtime.funcCall("bit_and", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  bitOr(): types.Int2<0 | 1> { const [__rt, ...__rest] = runtime.match([], [[[], types.Int2]]); return runtime.funcCall("bit_or", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  bitXor(): types.Int2<0 | 1> { const [__rt, ...__rest] = runtime.match([], [[[], types.Int2]]); return runtime.funcCall("bit_xor", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  max(): types.Int2<0 | 1> { const [__rt, ...__rest] = runtime.match([], [[[], types.Int2]]); return runtime.funcCall("max", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  min(): types.Int2<0 | 1> { const [__rt, ...__rest] = runtime.match([], [[[], types.Int2]]); return runtime.funcCall("min", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
