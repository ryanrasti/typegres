...
export class Text<in out N extends number> extends Anynonarray<N> {
  ...
  @expose.unchecked()
  datePart(arg0: unknown): any { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Date }], types.Float8], [[{ type: types.Time }], types.Float8], [[{ type: types.Timestamp }], types.Float8], [[{ type: types.Interval }], types.Float8], [[{ type: types.Timetz }], types.Float8]]); return runtime.funcCall("date_part", [this, ...__rest], __rt) as any; }
  ...
  @expose.unchecked()
  extract(arg0: unknown): any { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Date }], types.Numeric], [[{ type: types.Time }], types.Numeric], [[{ type: types.Timestamp }], types.Numeric], [[{ type: types.Interval }], types.Numeric], [[{ type: types.Timetz }], types.Numeric]]); return runtime.funcCall("extract", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  ...
  @expose.unchecked()
  similarToEscape(arg0?: unknown): any { const [__rt, ...__rest] = runtime.match([arg0], [[[], types.Text], [[{ type: types.Text, allowPrimitive: true }], types.Text]]); return runtime.funcCall("similar_to_escape", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  ...
  @expose.unchecked()
  substr(arg0: unknown, arg1?: unknown): any { const [__rt, ...__rest] = runtime.match([arg0, arg1], [[[{ type: types.Int4, allowPrimitive: true }], types.Text], [[{ type: types.Int4, allowPrimitive: true }, { type: types.Int4, allowPrimitive: true }], types.Text]]); return runtime.funcCall("substr", [this, ...__rest], __rt) as any; }
  ...
  @expose.unchecked()
  toAscii(arg0?: unknown): any { const [__rt, ...__rest] = runtime.match([arg0], [[[], types.Text], [[{ type: types.Int4, allowPrimitive: true }], types.Text]]); return runtime.funcCall("to_ascii", [this, ...__rest], __rt) as any; }
  @expose.unchecked()
  ...
  @expose.unchecked()
  ['@@'](arg0: unknown): any { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Text, allowPrimitive: true }], types.Bool], [[{ type: types.Tsquery }], types.Bool]]); return runtime.opCall(runtime.sql`@@`, [this, ...__rest] as [unknown, unknown], __rt) as any; }
  @expose.unchecked()
  ['^@']<M0 extends types.Text<any> | string>(arg0: M0): types.Bool<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Text, allowPrimitive: true }], types.Bool]]); return runtime.opCall(runtime.sql`^@`, [this, ...__rest] as [unknown, unknown], __rt) as any; }
  ...
  @expose.unchecked()
  ['||'](arg0: unknown): any { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Text, allowPrimitive: true }], types.Text], [[{ type: types.Anynonarray }], types.Text]]); return runtime.opCall(runtime.sql`||`, [this, ...__rest] as [unknown, unknown], __rt) as any; }
  @expose.unchecked()
  ['~']<M0 extends types.Text<any> | string>(arg0: M0): types.Bool<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Text, allowPrimitive: true }], types.Bool]]); return runtime.opCall(runtime.sql`~`, [this, ...__rest] as [unknown, unknown], __rt) as any; }
  @expose.unchecked()
  ['~*']<M0 extends types.Text<any> | string>(arg0: M0): types.Bool<runtime.StrictNull<N | runtime.NullOf<M0>>> { const [__rt, ...__rest] = runtime.match([arg0], [[[{ type: types.Text, allowPrimitive: true }], types.Bool]]); return runtime.opCall(runtime.sql`~*`, [this, ...__rest] as [unknown, unknown], __rt) as any; }
